...
tar -xzf SDL2-*.tar.gz
pushd SDL2-* && ./configure --prefix="$HOME" && make && make install && popd
...
pushd SDL2_image-* && ./configure --prefix="$HOME" && make && make install && popd
pushd SDL2_mixer-* && ./configure --prefix="$HOME" && make && make install && popd
pushd SDL2_ttf-* && ./configure --prefix="$HOME" && make && make install && popd
pushd SDL2_net-* && ./configure --prefix="$HOME" && make && make install && popd
