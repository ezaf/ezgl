...
#ifndef EZGL_GRAVITY_HPP
#define EZGL_GRAVITY_HPP

/** @file       EzGL/Gravity.hpp
...
EZGL_COMPONENT_ENLIST(Gravity);

class Gravity final : public Component<Gravity>
{
public:
    Gravity() = default;
    ~Gravity() = default;
