...
/** @file       EzGL/PlatformerLogic.hpp
 *  @brief      PlatformerLogic component.
...
EZGL_COMPONENT_ENLIST(PlatformerLogic);

class PlatformerLogic final : public Component<PlatformerLogic>
{
public:
    PlatformerLogic() = default;
    ~PlatformerLogic() = default;
